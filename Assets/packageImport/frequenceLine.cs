...
/// </summary>
public class frequenceLine : MonoBehaviour
{
    //[SerializeField]
    ...
    void Update()
    {
        ...
        if (sc_syncvar != null)
        {
            //Debug.Log(sc_syncvar.potar2value);
        ...
        //        deltaPos.y = initMousePos.y - curMousePos.y;
        //        deltaPos.x = initMousePos.x - curMousePos.x;

        //        amplitude -= deltaPos.normalized.y / 10;
        //        frequence += deltaPos.normalized.x;
